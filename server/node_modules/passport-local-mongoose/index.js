...
module.exports = function (schema, options) {
  ...
  options.errorMessages.MissingPasswordError = options.errorMessages.MissingPasswordError || "Aucun mot de passe n'a été défini";
  options.errorMessages.AttemptTooSoonError = options.errorMessages.AttemptTooSoonError || 'Ce compte est bloqué pour le moment. Veuillez réessayer ultérieurement.';
  options.errorMessages.TooManyAttemptsError = options.errorMessages.TooManyAttemptsError || 'Le compte a été bloqué à cause de trop de tentatives infructueuses. Merci de contacter le service client à bene@bombomlife.com';
  options.errorMessages.NoSaltValueStoredError = options.errorMessages.NoSaltValueStoredError || "L'authentification n'est pas possible.";
  options.errorMessages.IncorrectPasswordError = options.errorMessages.IncorrectPasswordError || "Le mot de passe ou l'email est incorrect.";
  options.errorMessages.IncorrectUsernameError = options.errorMessages.IncorrectUsernameError || "Le mot de passe ou l'email est incorrect.";
  options.errorMessages.MissingUsernameError = options.errorMessages.MissingUsernameError || "Aucun email n'a été défini.";
  options.errorMessages.UserExistsError = options.errorMessages.UserExistsError || 'Un utilisateur est déjà enregistré avec cet email.';
